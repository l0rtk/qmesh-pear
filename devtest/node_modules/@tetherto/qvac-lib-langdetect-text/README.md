# qvac-lib-langdetect-text

`qvac-lib-langdetect-text` is a language detection library for qvac. It provides an interface for detecting the language of a given text, returning either the single most likely language or the top K probable languages.
...
```javascript
const LangDetect = require("qvac-lib-langdetect-text");
