...
const BaseInference = require('@tetherto/infer-base')

const { QvacErrorBase } = require('@tetherto/qvac-lib-error-base')
const { QvacInferGgmlBaseError, ERR_CODES } = require('./lib/error')

class GGMLBase extends BaseInference {
  /**
  ...
  async _loadWeights (source, close = true, progressReporter = null) {
    if (!source) {
      throw new QvacInferGgmlBaseError(
  ...
  _handleError (err, errorCode) {
    ...
    throw new QvacInferGgmlBaseError(errorCode, err.message)
  }
}

module.exports = GGMLBase
